<?php 
	$qbo_invoice_id = get_post_meta( $ref_id, '_qbo_invoice_number', true);
	if($qbo_invoice_id){
		$data = array(
				'qbo_invoice_number'	=> cptexturize( $qbo_invoice_id ),//get_post_meta( $ref_id, '_qbo_invoice_number', true),
