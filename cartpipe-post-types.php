<?php 
	...
	$labels = array(
		'name'               => _x( 'Imported Items',  'cartpipe' ),
		'singular_name'      => _x( 'Imported Item',  'cartpipe' ),
		'menu_name'          => _x( 'Imported Items',  'cartpipe' ),
		'name_admin_bar'     => _x( 'Imported Items',  'cartpipe' ),
		'add_new'            => _x( 'Add New',  'cartpipe' ),
		'add_new_item'       => __( 'Add New Imported Item', 'cartpipe' ),
		'new_item'           => __( 'New Imported Item', 'cartpipe' ),
		'edit_item'          => __( 'Edit Imported Item', 'cartpipe' ),
		'view_item'          => __( 'View Imported Item', 'cartpipe' ),
		'all_items'          => __( 'Imported Items', 'cartpipe' ),
		'search_items'       => __( 'Search Imported Items', 'cartpipe' ),
		'parent_item_colon'  => __( 'Parent Imported Item:', 'cartpipe' ),
		'not_found'          => __( 'No imported items found.', 'cartpipe' ),
		'not_found_in_trash' => __( 'No imported items found in Trash.', 'cartpipe' )
	);
	...
	register_post_type( 'imported_item', $args );
	$labels = array(
		'name'              => _x( 'Import Status', 'cartpipe' ),
		'singular_name'     => _x( 'Import Status', 'cartpipe' ),
		'search_items'      => __( 'Import Statuses', 'cartpipe' ),
		'all_items'         => __( 'Import Statuses', 'cartpipe'),
		'parent_item'       => __( 'Parent Import Status', 'cartpipe' ),
		'parent_item_colon' => __( 'Parent Import Status:', 'cartpipe' ),
		'edit_item'         => __( 'Edit Import Status', 'cartpipe' ),
		'update_item'       => __( 'Update Import Status', 'cartpipe' ),
		'add_new_item'      => __( 'Add New Import Status','cartpipe' ),
		'new_item_name'     => __( 'New Import Status', 'cartpipe'),
		'menu_name'         => __( 'Import Status', 'cartpipe' ),
	);
	...
	$args = array(
		...
		'query_var'         => true,
		'rewrite'           => array( 'slug' => 'import_status' ),
	);

	register_taxonomy( 'import_status', array( 'imported_item' ), $args );
